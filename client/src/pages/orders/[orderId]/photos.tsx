    ...
    <div className="p-6">
      ...
      {tab.qc.status === 'yellow' && tab.qc.openIssues > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-yellow-700">Missing required bathroom photos</p>
        </div>
      )}

      <div className="bg-card border border-border rounded-lg p-6">
        <h3 className="font-medium text-foreground mb-4">Photo Gallery</h3>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-muted rounded-lg p-4 text-center">
            <div className="w-full h-32 bg-gray-200 rounded mb-2 flex items-center justify-center text-gray-500">
              <span className="text-sm" data-testid="photo-placeholder-front">Front Exterior</span>
            </div>
          </div>
          <div className="bg-muted rounded-lg p-4 text-center">
            <div className="w-full h-32 bg-gray-200 rounded mb-2 flex items-center justify-center text-gray-500">
              <span className="text-sm" data-testid="photo-placeholder-living">Living Room</span>
            </div>
          </div>
        </div>
      </div>
